...
![Build Status](https://github.com/Asaez-ts/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
These labs are designed to be executed in the IBM Developer Skills Network Cloud IDE with OpenShift. Please use the links provided in the Coursera Capstone to access the lab environment.
